...
public class start extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.notif_gita);
        ...
        public void onClick(View view) {
            ...
            Intent resultIntent = new Intent(gita_notif.this, .class);
            TaskStackBuilder stackBuilder = TaskStackBuilder.create(gita_notif.this);
            ...
            NotificationCompat.Builder builder = new NotificationCompat.Builder(notif_gita.this, CHANNEL_ID)
