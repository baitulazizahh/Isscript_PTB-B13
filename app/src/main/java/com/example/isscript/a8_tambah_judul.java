    ...
    public void tambahjudul() {
        ...
        tambah_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Call<TambahJudulResponse> call = client.tambahjdl(title,abstracts, lecturer_id, position,"Bearer "+token);

                call.enqueue(new Callback<TambahJudulResponse>() {
                    @Override
                    public void onResponse(Call<TambahJudulResponse> call, Response<TambahJudulResponse> response) {

                        if (response.isSuccessful()) {
                            TambahJudulResponse tambahJudulResponse = response.body();
                            if (tambahJudulResponse != null) {
                                Toast.makeText(a8_tambah_judul.this, "Berhasil tambah judul", Toast.LENGTH_SHORT).show();
                            ...
                            Toast.makeText(a8_tambah_judul.this, "Gagal tambah judul ya", Toast.LENGTH_SHORT).show();
                        }
                    }

                    @Override
                    public void onFailure(Call<TambahJudulResponse> call, Throwable t) {
                        Toast.makeText(a8_tambah_judul.this, "Gagal tambah judul", Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
